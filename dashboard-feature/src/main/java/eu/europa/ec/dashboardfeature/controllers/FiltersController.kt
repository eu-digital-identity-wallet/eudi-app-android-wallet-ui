import eu.europa.ec.dashboardfeature.R
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_BY_ISSUER_GROUP_ID
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_BY_PERIOD_BEYOND_30
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_BY_PERIOD_EXPIRED
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_BY_PERIOD_GROUP_ID
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_BY_PERIOD_NEXT_30
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_BY_PERIOD_NEXT_7
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_BY_STATE_EXPIRED
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_BY_STATE_GROUP_ID
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_BY_STATE_VALID
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_SORT_DATE_ISSUED
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_SORT_DEFAULT
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_SORT_EXPIRY_DATE
import eu.europa.ec.dashboardfeature.model.FilterIds.FILTER_SORT_GROUP_ID
